...
const Section2 = () => {
  ...
  return (
    <div className="bg-slate-100">
      <div className=" m-auto py-11 md:pb-[10rem] w-10/12">
        <div className="flex gap-2">
          ...
          {/* <Lottie className="md:hidden  scale-x-[-1] min-w-[40%] translate-y-[-4rem]" animationData={animationData } /> */}
        </div>
        <AboutCounter />
      </div>
    </div>
