  ...
  return (
    <div className="mt-5 bg-[#18172B]">
      <div className="w-10/12 m-auto py-5">
        ...
        <div className="pt-5 text-slate-100">
          <ul>
            <li data-aos="fade-up">
              <small>
          ...
          <small>
            ...
            GO2bank, GoBank, Green Dot Bank and Bonneville Bank. All of these
          ...
          <small data-aos="fade-up">
            ...
            protection from creditors that are only available for investments in
            that state’s qualified tuition program. The effectiveness of the
          ...
          <br />
          <small data-aos="fade-up">
            There is a chance that trading attributed to tax loss harvesting may
            create capital gains and wash sales and could be subject to higher
            transaction costs and market impacts. In addition, tax loss
            harvesting strategies may produce losses, which may not be offset by
            sufficient gains in the account and may be limited to a $3,000
            deduction against income. The utilization of losses harvested
            ...
            capital gains, if any. All investing involves risk, including the
            possible loss of money you invest, and past performance does not
            guarantee future performance. Historical returns, expected returns,
